...
- `raw_render`: if `true` and the model is Gemma 4, multimodal placeholders like `<|image|>` in a raw prompt will be expanded to reference attached images. This allows raw mode to support images for Gemma 4.
